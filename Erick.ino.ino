...
// WiFi Credentials
const char* ssid = "GEEH ENTERPISES UL";
...
String htmlPage()
{
  ...
  <head>
      ...
      <title>GIBAYI ERIC Systems - Smart Lighting</title>
      <style>
          body {
  ...
  <body>
      ...
      <footer>&copy; 2025 GIBAYI ERIC Systems | BYTEBLOOM GAT301</footer>
  </body>
  </html>
  )rawliteral";
